  ...
  Future<sqflite.Database> open(
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `CartItemsEntity` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `itemName` TEXT NOT NULL, `itemQuantity` INTEGER NOT NULL, `selectedBase` TEXT NOT NULL, `selectedSize` TEXT NOT NULL, `addon` INTEGER NOT NULL, `total` INTEGER NOT NULL, `itemModel` TEXT NOT NULL)');
