...
import '../../../home/outlet_details/outlet_shift_details_controller.dart';
import '../../../home/outlet_details/outlet_shift_details_model.dart';
...
class DeliveryLaterController extends GetxController {
  ...
  Map<String, ShiftData?>? shiftListDetailsModel = <String, ShiftData?>{}.obs;
  ...
  void getShiftDetails() {
    shiftListDetailsModel =
        outletShiftDetailsController.outletShiftDetailsModel.value.data;
    update();
  }

  Widget getTime(RegularShift shiftData) {
