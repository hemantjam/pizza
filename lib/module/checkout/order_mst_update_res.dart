...
//
//     final orderMstUpdateRes = orderMstUpdateResFromJson(jsonString);

import 'dart:convert';

OrderMstUpdateRes orderMstUpdateResFromJson(String str) => OrderMstUpdateRes.fromJson(json.decode(str));

String orderMstUpdateResToJson(OrderMstUpdateRes data) => json.encode(data.toJson());

class OrderMstUpdateRes {
  String? message;
  bool? status;
  Data? data;
  ...
  factory OrderMstUpdateRes.fromJson(Map<String, dynamic> json) => OrderMstUpdateRes(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    userId: json["userId"],
    orderDtlWebRequestSet: json["orderDTLWebRequestSet"] == null ? [] : List<OrderDtlWebRequestSet>.from(json["orderDTLWebRequestSet"]!.map((x) => OrderDtlWebRequestSet.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "userId": userId,
    "orderDTLWebRequestSet": orderDtlWebRequestSet == null ? [] : List<dynamic>.from(orderDtlWebRequestSet!.map((x) => x.toJson())),
...
class OrderDtlWebRequestSet {
  ...
  factory OrderDtlWebRequestSet.fromJson(Map<String, dynamic> json) => OrderDtlWebRequestSet(
    ...
    orderRecipeItemWebRequestSet: json["orderRecipeItemWebRequestSet"] == null ? [] : List<OrderRecipeItemWebRequestSet>.from(json["orderRecipeItemWebRequestSet"]!.map((x) => OrderRecipeItemWebRequestSet.fromJson(x))),
    active: json["active"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "combSeq": combSeq,
    "orderRecipeItemWebRequestSet": orderRecipeItemWebRequestSet == null ? [] : List<dynamic>.from(orderRecipeItemWebRequestSet!.map((x) => x.toJson())),
    "active": active,
  };
}
