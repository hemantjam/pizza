...
class LoginModel {
  ...
  factory LoginModel.fromJson(Map<String, dynamic> json) => LoginModel(
        ...
        userMst:
            json["userMST"] == null ? null : UserMst.fromJson(json["userMST"]),
      );
...
class UserMst {
  ...
  UserMst copyWith({
    ...
    bool? active,
      ...
      UserMst(
        ...
        userGroupManagerMstId:
            userGroupManagerMstId ?? this.userGroupManagerMstId,
        ...
        forgotPasswordOtpExpiry:
            forgotPasswordOtpExpiry ?? this.forgotPasswordOtpExpiry,
        userOutletAccessDtlList:
            userOutletAccessDtlList ?? this.userOutletAccessDtlList,
  ...
  factory UserMst.fromJson(Map<String, dynamic> json) => UserMst(
        ...
        userGroupMst: json["userGroupMST"] == null
            ? null
            : UserGroupMMst.fromJson(json["userGroupMST"]),
        userRoleMstId: json["userRoleMSTId"],
        userRoleMst: json["userRoleMST"] == null
            ? null
            : UserRoleMst.fromJson(json["userRoleMST"]),
        userGroupManagerMstId: json["userGroupManagerMSTId"],
        userGroupManagerMst: json["userGroupManagerMST"] == null
            ? null
            : UserGroupMMst.fromJson(json["userGroupManagerMST"]),
        gender: json["gender"],
        ...
        userOutletAccessDtlList: json["userOutletAccessDTLList"] == null
            ? []
            : List<dynamic>.from(
                json["userOutletAccessDTLList"]!.map((x) => x)),
        userAddressMstList: json["userAddressMSTList"] == null
            ? []
            : List<dynamic>.from(json["userAddressMSTList"]!.map((x) => x)),
        lock: json["lock"],
        ipUser: json["ipUser"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "userOutletAccessDTLList": userOutletAccessDtlList == null
            ? []
            : List<dynamic>.from(userOutletAccessDtlList!.map((x) => x)),
        "userAddressMSTList": userAddressMstList == null
            ? []
            : List<dynamic>.from(userAddressMstList!.map((x) => x)),
        "lock": lock,
        "ipUser": ipUser,
